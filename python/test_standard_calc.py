...
def test_between_no_bounding():
    ...
    assert is_angle_between(-10, 100, 10) == False
    assert is_angle_between(-180, -170, -160) == True
    
def test_between_with_bounding():
    assert is_angle_between(45, 90, 270) == False
    assert is_angle_between(45, -10, 270) == True
    assert is_angle_between(170, -180, -170) == False
    assert is_angle_between(170, -175, 180) == True

def test_between_edge_cases():
    assert is_angle_between(180, 0, -180) == False
    assert is_angle_between(-180, 0, 180) == False
    assert is_angle_between(-180, -178, 179) == True
    assert is_angle_between(-178, 179, 180) == False
